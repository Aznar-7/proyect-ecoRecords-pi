...
def shutdown():
    config = read_config()
    config["now_playing"] = {
        "album": None, "track": 0, "track_name": None,
    ...
    try:
        ...
        if process.returncode == 0:
            ...
            download_status.update({
                ...
                "error":   "yt-dlp termino con error"
            })
...
def start_download():
    ...
    if not album_name:
        return jsonify({"ok": False, "error": "Nombre de album requerido"}), 400
